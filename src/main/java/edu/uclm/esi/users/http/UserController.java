...
public class UserController {
	...
	public ResponseEntity<String> addCredits(@RequestBody Double creditsToAdd) {
		userService.addCredits(creditsToAdd);
		return ResponseEntity.ok("Créditos actualizados.");
	}
